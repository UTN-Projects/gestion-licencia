...
public class InterfazModificarDatosTitular extends JFrame {
	...
	private JTextField textEsDonante;
	...
	public InterfazModificarDatosTitular(Titular titularMod) {
		...
		textEsDonante = new JTextField();
        ((AbstractDocument) textEsDonante.getDocument()).setDocumentFilter(new NumericAndLengthFilter(1));
		textEsDonante.setForeground(new Color(69, 69, 69));
		textEsDonante.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textEsDonante.setDisabledTextColor(Color.WHITE);
		textEsDonante.setColumns(10);
	...
	public void modificarDatosUsuario() {
        ...
        Boolean esDonante;
        Integer auxString = Integer.parseInt(textEsDonante.getText());
        if(auxString == 1) esDonante = true;
        else if(auxString == 0) esDonante = false;
        else esDonante = null;
        //Boolean.parseBoolean(textEsDonante.getText());
        ...
        if (esDonante != null) {
            titularActual.setEsDonante(esDonante);
        }
        ...
        DBManager.getInstance().actualizarTitular(titularActual, titularViejo);
    }
       
	public void abrirMensajeModificadoExito() {
		MensajeModificadoExito mensajeModEx = new MensajeModificadoExito(new InterfazModificarDatosUsuario(null));
