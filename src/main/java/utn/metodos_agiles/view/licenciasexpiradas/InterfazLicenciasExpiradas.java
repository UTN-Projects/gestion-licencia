...
public class InterfazLicenciasExpiradas extends JFrame {
	...
	public InterfazLicenciasExpiradas() {
        ...
        licencias = LicenciaController.getInstance().licenciasVencidas();

        TableModel tableModel = new LicenciasExpiradasTableModel(licencias);
	...
	private void buscarLicencias() {
        ...
        tablaDatos.setModel(new LicenciasExpiradasTableModel(licenciasFiltered));
