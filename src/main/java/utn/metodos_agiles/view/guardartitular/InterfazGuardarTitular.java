...
import utn.metodos_agiles.controller.ContribuyenteController;
...
import utn.metodos_agiles.view.InterfazGenerarLicenciaContribuyente;
...
import utn.metodos_agiles.view.dialogs.AdvertenciaTitularExistente;
...
public class InterfazGuardarTitular extends JFrame {
	...
	public InterfazGuardarTitular() {
        ...
        tablaDatos.setModel(new GuardarTitularTableModel(List.of()));
        	...
        	public void mouseClicked(MouseEvent e) {
        		...
        		if (interfazLicenciaContribuyente == null) {
                    if(contribuyente!=null){
                        Titular auxTitular = LicenciaController.getInstance().obtenerTitular(contribuyente.getDni());
                        if(auxTitular == null){
	...
	private Contribuyente buscarContribuyente() {
		...
		int dni = Integer.parseInt(txtDni.getText());
		    Contribuyente contribuyente = ContribuyenteController.getInstance().obtenerContribuyebte(dni);
		    if (contribuyente != null) {
		        tablaDatos.setModel(new GuardarTitularTableModel(List.of(contribuyente)));
		    } else {
