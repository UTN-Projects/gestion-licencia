...
public class AdvertenciaTitularExistente extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	 private InterfazGuardarTitular interfazGuardarTitular;
	 
	public AdvertenciaTitularExistente(InterfazGuardarTitular interfazGuardarTitular) {
		...
		JLabel txtExitoso = new JLabel("El titular ya existe en la base de datos.");
